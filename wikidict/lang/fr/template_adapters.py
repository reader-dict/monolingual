...
adapters = {
    ...
    **dict.fromkeys(
    ...
    "Modèle:siècle": lambda _: """{{#ifeq:{{{1|}}}|?||{{#if:{{{1|}}}|<span class="siècle">''({{#invoke:date et heure|formate_un_siecle|{{{1|}}}|lang={{{lang|{{{langue|}}}}}}}}{{#if:{{{2|}}}|&#32;–&#32;{{#invoke:date et heure|formate_un_siecle|{{{2}}}}}}})''</span>|}}}}""",
