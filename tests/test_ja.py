...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            [],
            [
                '近松門左衛門作の浄瑠璃『関八州繋馬』（享保9年1月15日初演）で初出とされる。<blockquote class="toccolours" style="float:none; display:table; border: 1px solid #aaa;">…是こんな人出來るぞや〳〵、上から下までお目出度と、<b>猫の手もかりたい</b>忙しさ、その泣顔はなんぞ氣色でもわるいか、御新造のお部屋の掃除おろそかに致すなと、お局の云付人にばかり骨おらせ、…<cite style="display: block; text-align: right;">—&thinsp;近松門左衛門『関八州繋馬』</cite>明治23年に武蔵屋叢書閣から出版された翻刻本22頁より<br/>原文では「か」は可の変体仮名で表記</blockquote>'
            ],
            {
                "成句": ["とても忙しく、些細な手伝いでも望まれるほどに人手が不足していることのたとえ。"],
                "類義語": ["盆と正月が一緒に来たよう"],
            },
            [],
            [],
