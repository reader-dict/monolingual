    ...
    [
        (
            ...
            ],
            {
                ...
                "Noun": [
                    "(informal) Clipping of <i>abdominal muscle</i> &lsqb;mid 20<sup>th</sup> century&rsqb;.",
                ...
                "Symbol": ["(international standards) <i>ISO 639-1 language code for </i><b>Abkhaz</b><i>.</i>"],
        ...
        (
            ...
            ],
            {
                ...
                "Noun": ["(obsolete) A cause; something that causes an effect."],
            },
            [],
        ),
        (
        ...
        (
            ...
            ],
            {
                "Contraction": [
                    ...
                    "(proscribed) Contraction of <i>it was</i>",
        ...
        (
            ...
            ],
            {
                ...
                "Proper Noun": [
                    "(astronomy) The fourth planet in the solar system. Symbol: <b>♂</b>",
        ...
        (
            ...
            ],
            {
                ...
                "Verb": ["(transitive) To create a portmanteau word."],
            },
            [],
        ),
        (
        ...
        (
            ...
            ],
            {
                ...
                "Symbol": [
                    "(international standards) <i>ISO 639-3 language code for </i><b>Chitwania Tharu</b><i>.</i>"
                ],
            },
            [],
        ),
        (
            ...
            ],
            {
                "Interjection": [
                    ...
                    "(chiefly&#32;US) Dated spelling of <i>mmm</i>.",
                ...
                "Verb": ["(intransitive) To make the <i>um</i> sound to express uncertainty or hesitancy."],
            },
            [],
        ),
        (
            ...
            ],
            {
                ...
                "Noun": ["(rare) Alternative form of <i>u's</i>."],
                "Pronoun": [
        ...
        (
            ...
            {
                "Noun": [
                    "(uncountable) A inorganic compound (of molecular formula H<sub>2</sub>O) found at room temperature and pressure as a clear liquid; it is present naturally as rain, and found in rivers, lakes and seas; its solid form is ice and its gaseous form is steam.",
                    (
        ...
        (
            ...
            ],
            {
                ...
                "Noun": [
                    "(semantics) The smallest unit of language that has a particular meaning and can be expressed by itself; the smallest discrete, meaningful unit of language. (contrast <i>morpheme</i>.)",
                    (
                    ...
                    (
                        ...
                        "(telegraphy) A unit of text equivalent to five characters and one space. &lsqb;from 19th c.&rsqb;",
                        "(computing) A fixed-size group of bits handled as a unit by a machine and which can be stored in or retrieved from a typical register (so that it has the same size as such a register). &lsqb;from 20th c.&rsqb;",
                        "(computing) With regards to Intel or Intel-compatible hardware and/or in the context of Windows programming, a group of exactly 16 bits regardless of the actual processor capabilities; a fossilized unit referring to the small word size of historical CPUs. &lsqb;from 20th c.&rsqb;",
                        "(computer science) A finite string that is not a command or operator. &lsqb;from 20th c.&rsqb;",
                        "(group theory) A group element, expressed as a product of group elements.",
                    ),
                    "The fact or act of speaking, as opposed to taking action. &lsqb;from 9th c&rsqb;.",
                    "(now&#32;rare&#32;outside certain phrases) Something that someone said; a comment, utterance; speech. &lsqb;from 10th c.&rsqb;",
                    ...
                    "(uncountable) News; tidings. &lsqb;from 10th c.&rsqb;",
                    ...
                    "(in the plural) <i>See</i> <b>words</b>.",
