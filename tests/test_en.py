...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            {
                "Adverb": ["<i>Abbreviation of</i> <b>about</b>"],
                "Noun": [
                ...
                "Preposition": ["<i>Abbreviation of</i> <b>about</b>"],
                "Symbol": ["(<i>international standards</i>) <i>ISO 639-1 language code for</i> <b>Abkhaz</b>."],
                "Verb": ["<i>(climbing, informal)</i> To abseil.", "<i>Abbreviation of</i> <b>abort</b>"],
            },
            [],
        ),
        (
        ...
        (
            ...
            ],
            {
                ...
                "Determiner": ["<i>Obsolete form of</i> <b>its</b>", "<i>Misspelling of</i> <b>its</b>"],
            },
            [],
        ),
        (
        ...
        (
            ...
            ],
            {
                ...
                "Pronoun": ["<i>Obsolete form of</i> <b>thee</b>"],
            },
            [],
        ),
        (
            ...
            ["Onomatopoeic."],
            {
                ...
                "Symbol": ["micrometer; variant of μm used when the character μ is unavailable"],
        ...
        (
            ...
            ],
            {
                ...
                "Symbol": ["<i>Alternative spelling of</i> <b>µs</b>: microsecond"],
            },
            [],
        ),
        (
            ...
            [
                ...
                "Cognate with cf, North Frisian <i>weeter</i> (“water”), Saterland Frisian <i>Woater</i> (“water”), West Frisian <i>wetter</i> (“water”), Dutch <i>water</i> (“water”), Low German <i>Water</i> (“water”), German <i>Wasser</i>, Old Norse <i>vatn</i> (Swedish <i>vatten</i> (“water”), Danish <i>vand</i> (“water”), Norwegian Bokmål <i>vann</i> (“water”), Norwegian Nynorsk and Icelandic <i>vatn</i> (“water”), Old Irish <i>coin fodorne</i> (“otters”, literally “water-dogs”), Latin <i>unda</i> (“wave”), Lithuanian <i>vanduõ</i> (“water”), Russian <i>вода́</i> (<i>vodá</i>, “water”), Albanian <i>ujë</i> (“water”), Ancient Greek <i>ὕδωρ</i> (<i>húdōr</i>, “water”), Armenian <i>գետ</i> (“river”), Sanskrit <i>उदन्</i> (<i>udán</i>, “wave, water”), Hittite <i>𒉿𒀀𒋻</i> (<i>wa-a-tar</i>).",
