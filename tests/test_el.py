        ...
        (
            ...
            [],
            {
                "Πρόθημα": [
                    ...
                    ("<b>ανα</b>δουλειά", "<b>ανά</b>πλατος"),
                ]
            },
            [],
        ),
        ...
        (
            ...
            ],
            {
                "Ουσιαστικό": [
                    ...
                    "η στάθμη",
                    ("&nbsp; <i>το <b>επίπεδο</b> του νερού</i>",),
                    "το ύψος όπου βρίσκεται κάτι σε μια ιεραρχική κλίμακα",
                    ("&nbsp; <i>μια χώρα με ψηλό βιοτικό <b>επίπεδο</b></i>",),
                    "(<i>μεταφορικά</i>) η σπουδαιότητα, η σημαντικότητα",
                    ("&nbsp; <i>Το <b>επίπεδο</b> της συζήτησης ήταν πολύ χαμηλό.</i>",),
                ]
            },
            ["επίπεδος"],
        ),
        (
            ...
            ],
            {
                "Ρήμα": [
                    ...
                    ("&nbsp; <i>αν με <b>λαμβάνει</b> κανείς, ας απαντήσει</i>", "<i><b>ελήφθη</b>, όβερ</i>"),
                    "(<i>μεταφορικά</i>) καταλαβαίνω",
                    ("&nbsp; <i>Δε με λαμβάνεις σήμερα.</i>",),
                ]
            },
            [],
        ),
